...
def set_status(text):
    ...
    set_status.after_id = root.after(
        STATUS_CLEAR_MS,
...
canvas = tk.Canvas(root, bg=BG_CANVAS, highlightthickness=0)
canvas.pack()
...
tk.Label(controls, text="Step 1:", bg=BG_MAIN, fg=FG_MUTED)\
    .grid(row=0, column=0, sticky="e")
dark_button(controls, "Open Video", open_video)\
    .grid(row=0, column=1, padx=5)

tk.Label(controls, text="Step 2:", bg=BG_MAIN, fg=FG_MUTED)\
    .grid(row=0, column=2, sticky="e")
dark_button(controls, "Generate Command", generate_ffmpeg)\
    .grid(row=0, column=3, padx=5)

tk.Label(controls, text="Step 3:", bg=BG_MAIN, fg=FG_MUTED)\
    .grid(row=0, column=4, sticky="e")
dark_button(controls, "Copy Command", copy_command)\
    .grid(row=0, column=5, padx=5)

tk.Label(root, text="Output filename:", bg=BG_MAIN, fg=FG_TEXT).pack()
